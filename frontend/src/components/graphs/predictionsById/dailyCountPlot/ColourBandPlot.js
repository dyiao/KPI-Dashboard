                ...
                <Bar dataKey="count" name="Count">
                    {
                        dailyData.map((entry, _index) => {
                            return (
                                <Cell key={_index} fill={entry.status === "NORMAL" ? '#00FF00' : (entry.status === "WARNING" ? '#FFFF00' : '#FF0000')} fillOpacity={0.5} />
                            )
                        })
                    }
                </Bar>
